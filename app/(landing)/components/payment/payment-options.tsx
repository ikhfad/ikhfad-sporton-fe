...
const paymentsList = [
  {
    bank_name: "BCA",
    account_number: 8792149719496,
    account_holder: "PT SportOn Digital",
  },
  {
    bank_name: "BRI",
    account_number: 7659791874917,
    account_holder: "PT SportOn Digital",
  },
  {
    bank_name: "Mandiri",
    account_number: 9462875629486,
    account_holder: "PT SportOn Digital",
  },
];
    ...
    <CardWithHeader title="Payment Options">
      {paymentsList.map((payment, index) => (
        <div className="flex gap-5 p-5 border-b border-gray-100" key={index}>
          <div className="bg-blue-100 p-4 text-blue-500 flex justify-center items-center">
